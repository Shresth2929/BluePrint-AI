...
export default function SignInPage() {
  return (
    <div className="min-h-screen grid-bg flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* Aurora blobs */}
      <div className="aurora-blob-1 w-96 h-96 bg-violet-600/15 -top-20 -left-20 pointer-events-none" />
      <div className="aurora-blob-2 w-80 h-80 bg-indigo-600/10 bottom-10 right-10 pointer-events-none" />
